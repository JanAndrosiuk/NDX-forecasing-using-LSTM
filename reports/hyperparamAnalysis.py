...
hyperparamLogList = ['./reports/model_hyperparams_2023-10-22_15-48.json', './reports/model_hyperparams_2023-10-22_17-49.json']
for f in hyperparamLogList:
    ...
    df[['learning_rate', 'units', 'dropout', 'hidden_layers']].hist(bins=70)
    plt.title(f)
    plt.show()